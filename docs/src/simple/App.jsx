...
export default class App extends Component {
  ...
  componentDidMount() {
    axios.get('./api/simple.json').then(({ data: tree }) => this.setState({
      tree,
      loading: false,
    }));
  }
  ...
  render() {
    ...
    return <Tree store={this.store} dataSource={tree} loading={loading} prefix="/resources" selectedKeys={menuIds} />;
  }
}
